...
import sunwell.permaisuri.ws.service.RegistrationSvc;
...
//    UserSessionContainer usc;
	...
	@RequestMapping(value = "resources/activate", method = RequestMethod.GET
...
//	@PreAuthorize("#oauth2.hasScope('read')")
	@RequestMapping(value = "resources/customers", method = RequestMethod.GET,
			produces = "application/json"
	)
...
//		@RequestParam(value="groupId", required = false) Integer _groupId,
		...
		) throws Exception 
	{
		...
		try {
    		...
    		CustomerDTO firstCust = null ; 		// testing
...
//    		}
			...
			//jmsTemplate.convertAndSend("customerRequested", firstCust);
    		retData = svcUtil.returnSuccessfulData(mainData, totalPages, totalItems);
		}
		catch (Exception e) {
			retData = svcUtil.handleException(e);
	...
	@RequestMapping(value = "resources/customers", method = RequestMethod.POST,
			consumes = "application/json", produces = "application/json"
	)
...
//            Customer data = regSvc.registerCustomer(_dto.getData());            
	...
	@RequestMapping(value = "resources/customers", method = RequestMethod.PUT,
			consumes = "application/json", produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/customers", method = RequestMethod.DELETE,
			produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/salesofficers", method = RequestMethod.GET,
			produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/salesofficers", method = RequestMethod.POST,
			consumes = "application/json", produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/salesofficers", method = RequestMethod.PUT,
			consumes = "application/json", produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/salesofficers", method = RequestMethod.DELETE,
			produces = "application/json"
	)
...
//        		}
	...
	@RequestMapping(value = "resources/users", method = RequestMethod.PUT,
			consumes = "application/json", produces = "application/json"
	)
	...
	@RequestMapping(value = "resources/users", method = RequestMethod.DELETE,
			produces = "application/json"
	)
    ...
    @RequestMapping(value = "resources/users/images", method = RequestMethod.GET,
